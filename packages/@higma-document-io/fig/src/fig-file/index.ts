 ...
 *
 * Note: For compression utilities, import from "@higma-codecs/compression"
 * Note: For constants and types, import from "@higma-document-models/fig/constants"
 */
...
// Note: Constants and enum types should be imported from "@higma-document-models/fig/constants"
// Examples:
//   import { PAINT_TYPE_VALUES, type PaintType } from "@higma-document-models/fig/constants";
//   import { STACK_MODE_VALUES, type StackMode } from "@higma-document-models/fig/constants";
