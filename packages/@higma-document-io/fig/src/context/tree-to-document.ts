...
import type { NodeTreeResult, FigBlob, FigGuid } from "@higma-document-models/fig/parser";
import { getNodeType, guidToString, parseGuidString } from "@higma-document-models/fig/parser";
...
import { guidToNodeId, guidToPageId } from "@higma-document-models/fig/domain";
 ...
 * primitive comes from `@higma-primitives/tree:walkTree` — local DFS
