/**
 * @file Extract the ICC profile bytes embedded in a JPEG's APP2 segments
 * without decoding pixel data. Format parsing only — no dependency on a
 * sibling codec package.
 */
...
export function extractJpegIccProfile(data: Uint8Array): IccProfile | undefined {
...
function assembleJpegIccProfile(segments: readonly JpegIccSegment[]): IccProfile | undefined {
