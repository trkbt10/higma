...
import type { FigGradientPaint, FigGradientStop, FigPaint, FigVector } from "@higma-document-models/fig/types";
import { Input } from "@higma-editor-kernel/ui/primitives/Input";
import { AddIcon, CloseIcon } from "@higma-editor-kernel/ui/icons";
import {
  paintInlineStyle,
  swatchStyle,
  addButtonStyle,
