...
import { calculateResizedDimensions } from "@higma-editor-kernel/core/geometry";
import { normalizeAngle } from "@higma-editor-kernel/core/geometry";
import { rotateShapeAroundCenter } from "@higma-editor-kernel/core/geometry";
import { pushHistory } from "@higma-editor-kernel/core/history";
import { updateNode } from "@higma-document-io/fig/node-ops";
