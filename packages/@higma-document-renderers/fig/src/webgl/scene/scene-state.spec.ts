...
import { diffSceneGraphs, createNodeId, type SceneGraph, type GroupNode, type RectNode } from "@higma-document-renderers/fig/scene-graph";
...
describe("SceneState", () => {
  ...
  describe("applyDiff", () => {
    ...
    it("should produce same draw list whether built fresh or via diff", () => {
      ...
      const freshState = createSceneState();
      ...
      const diffState = createSceneState();
