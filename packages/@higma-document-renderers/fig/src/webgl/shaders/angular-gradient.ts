/**
 * @file Angular gradient shader.
 */

export const angularGradientVertexShader = `
...
export const angularGradientFragmentShader = `
  ...
  void main() {
    ...
    vec2 delta = localPos - u_center;
    float angle = atan(delta.y, delta.x) - u_rotation;
    float t = mod(angle / (2.0 * PI) + 1.0, 1.0);
