...
/** Extract clockwise rotation from a FigMatrix in degrees. */
export function extractRotationDegrees(matrix: FigMatrix): number {
  return extractRotation(matrix) * (180 / Math.PI);
}
