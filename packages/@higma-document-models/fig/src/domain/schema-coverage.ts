...
export const KIWI_NODECHANGE_HANDLING: Readonly<Record<string, KiwiFieldHandling>> = {
  ...
  "inheritFillStyleID": { kind: "mapped", to: "inheritFillStyleID" },
  "inheritStrokeStyleID": { kind: "mapped", to: "inheritStrokeStyleID" },
  "inheritTextStyleID": { kind: "mapped", to: "inheritTextStyleID" },
  "inheritExportStyleID": { kind: "mapped", to: "inheritExportStyleID" },
  "inheritEffectStyleID": { kind: "mapped", to: "inheritEffectStyleID" },
  "inheritGridStyleID": { kind: "mapped", to: "inheritGridStyleID" },
  "inheritFillStyleIDForStroke": { kind: "mapped", to: "inheritFillStyleIDForStroke" },
  "styleIdForFill": { kind: "mapped", to: "styleIdForFill" },
  "styleIdForStrokeFill": { kind: "mapped", to: "styleIdForStrokeFill" },
  "styleIdForText": { kind: "mapped", to: "styleIdForText" },
  "styleIdForEffect": { kind: "mapped", to: "styleIdForEffect" },
  "styleIdForGrid": { kind: "mapped", to: "styleIdForGrid" },
  "backgroundPaints": { kind: "mapped", to: "backgroundPaints" },
  "inheritFillStyleIDForBackground": { kind: "mapped", to: "inheritFillStyleIDForBackground" },
  ...
  "symbolData": { kind: "mapped", to: "symbolData", note: "SymbolResolver reads symbolData.symbolID and symbolData.symbolOverrides directly; top-level overriddenSymbolID remains a NodeChange field." },
  "symbolDataTag": { kind: "dropped", reason: "kiwi-internal" },
  "derivedSymbolData": { kind: "mapped", to: "derivedSymbolData", note: "SymbolResolver consumes Kiwi derivedSymbolData directly and export preserves the field on FigNode." },
  ...
  "overriddenSymbolID": { kind: "mapped", to: "overriddenSymbolID", note: "SymbolResolver owns effective INSTANCE target selection; the GUID remains FigGuid." },
  ...
  "derivedTextData": { kind: "mapped", to: "derivedTextData" },
  ...
  "frameMaskDisabled": { kind: "mapped", to: "frameMaskDisabled" },
  ...
  "variableModeBySetMap": { kind: "mapped", to: "variableModeBySetMap" },
  "variableSetModes": { kind: "mapped", to: "variableSetModes" },
  "variableSetID": { kind: "mapped", to: "variableSetID" },
  "variableResolvedType": { kind: "mapped", to: "variableResolvedType" },
  "variableDataValues": { kind: "mapped", to: "variableDataValues" },
