 ...
 * used by the variant re-resolver. `@higma-document-models/fig/symbols` does not
 * import from `@higma-document-models/fig/domain` to keep the dependency direction
