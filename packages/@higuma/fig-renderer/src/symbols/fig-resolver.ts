 ...
 *  3. 解決ロジック本体は @higuma/fig/symbols の `resolveInstanceNode`
 ...
 *  `@higuma/fig/symbols/symbol-pre-resolver.preResolveSymbols` に
 *  集約済み。ここでローカル実装してはいけない。
 */

import type { FigNode } from "@higuma/fig/types";
import type { FigGuid, FigBlob } from "@higuma/fig/parser";
import {
  resolveInstanceNode,
...
export type { ResolvedInstanceNode, InstanceResolution } from "@higuma/fig/symbols";
