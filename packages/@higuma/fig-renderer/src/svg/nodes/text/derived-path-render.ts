...
import type { DerivedTextData, DerivedGlyph, DerivedDecoration } from "@higuma/fig/domain";
import { decodePathCommands, type FigBlob, type PathCommand } from "@higuma/fig/parser";
...
export function renderTextNodeFromDerivedData(node: FigNode, ctx: DerivedPathRenderContext): SvgString {
  ...
  // the local alias `DerivedTextData` from @higuma/fig/domain is structurally
