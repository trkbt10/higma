...
import type { FigBlob, FigImage } from "@higuma/fig/parser";
import type { FigSvgRenderResult } from "../types";
import type { SvgString } from "./primitives";
import type { FontLoader } from "../font";
import type { FigDesignNode, FigStyleRegistry } from "@higuma/fig/domain";
import { EMPTY_FIG_STYLE_REGISTRY } from "@higuma/fig/domain";
import { buildFigStyleRegistry } from "@higuma/fig/symbols";
import { convertFigNode } from "@higuma/fig-builder/context";
