 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-decoration-combo-fixtures.ts
 */
...
async function generateDecorationComboFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@higuma/fig-renderer/spec/decoration-combo.spec.ts`);
}
