 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-image-fill-fixtures.ts
 */
...
async function generateImageFillFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@higuma/fig-renderer/spec/image-fill.spec.ts`);
}
