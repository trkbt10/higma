 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-text-webgl-fixtures.ts
 */
...
import { createFigFile, frameNode, textNode, roundedRectNode, ellipseNode } from "@higuma/fig/builder";
import {
  generateTextGlyphs,
