 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-paint-advanced-fixtures.ts
 */
...
async function generatePaintAdvancedFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@higuma/fig-renderer/spec/paint-advanced.spec.ts`);
}
