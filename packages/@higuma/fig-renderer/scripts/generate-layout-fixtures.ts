 ...
 *
 * Usage: bun packages/@higuma/fig-renderer/scripts/generate-layout-fixtures.ts
 */

import * as fs from 'node:fs';
import * as path from 'node:path';
import { loadFigFile, saveFigFile } from "@higuma/fig/builder";
import type { FigNode } from "@higuma/fig/types";

const TEMPLATE_FILE = path.join(import.meta.dir, "../../../@higuma/fig/samples/sample-file.fig");
