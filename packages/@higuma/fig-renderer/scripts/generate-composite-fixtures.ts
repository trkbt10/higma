 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-composite-fixtures.ts
 *
 * After generation:
 *   1. Open the .fig in Figma
 *   2. Export each frame as SVG to fixtures/composite/actual/
 *   3. Run: npx vitest run packages/@higuma/fig-renderer/spec/composite.spec.ts
 */
...
async function generateCompositeFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@higuma/fig-renderer/spec/composite.spec.ts`);
}
