 ...
 *
 * Usage:
 *   bun packages/@higuma/fig-renderer/scripts/generate-effect-fixtures.ts
 */
...
async function generateEffectFixtures(): Promise<void> {
  ...
  console.log(`3. Run: npx vitest run packages/@higuma/fig-renderer/spec/effects.spec.ts`);
}
