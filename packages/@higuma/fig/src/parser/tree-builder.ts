 ...
 * (`@higuma/fig/symbols/resolve-context`) which interns the result
 ...
 *
 * Routes through the `walkTree` SoT primitive (`@higuma/fig/tree`)
 ...
 * `@higuma/fig/symbols/resolve-context`) which interns the result per
