...
import { getNodeType, safeChildren } from "@higuma/fig/parser";
import { walkTree as walkTreeGeneric } from "@higuma/fig/tree";
...
// Tree-walk primitive lives at `@higuma/fig/tree:walkTree` — the
