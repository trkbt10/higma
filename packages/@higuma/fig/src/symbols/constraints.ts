 ...
 *
 * Per-child constraint math lives in @higuma/fig/symbols (shared with builder).
...
import type { FigNode, FigMatrix, MutableFigNode } from "@higuma/fig/types";
import { CONSTRAINT_TYPE_VALUES } from "@higuma/fig/constants";
import { guidToString } from "@higuma/fig/parser";
import { getConstraintValue, resolveChildConstraints } from "@higuma/fig/symbols";
