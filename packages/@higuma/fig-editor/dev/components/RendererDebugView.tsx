...
import type { ParsedFigFile } from "@higuma/fig/parser";
import { parseFigFile, buildNodeTree, findNodesByType } from "@higuma/fig/parser";
import { loadFigFile } from "@higuma/fig/roundtrip";
import { treeToDocument } from "@higuma/fig-builder/context";
import type { FigDesignDocument, FigDesignNode } from "@higuma/fig/domain";
import type { FigNode } from "@higuma/fig/types";
import { preResolveSymbols } from "@higuma/fig/symbols";
import { renderCanvas } from "@higuma/fig-renderer/svg";
import { createBrowserFontLoader, isBrowserFontLoaderSupported } from "@higuma/fig-renderer/font-drivers/browser";
import { createCachingFontLoader } from "@higuma/fig-renderer/font";
import { buildSceneGraph } from "@higuma/fig-renderer/scene-graph";
import type { SceneGraph } from "@higuma/fig-renderer/scene-graph";
import { Button, Select, Tabs, Toggle, colorTokens, spacingTokens, fontTokens, radiusTokens } from "@higuma/ui-components";
import {
  InspectorCanvasOverlay,
  InspectorTreePanel,
  CategoryLegend,
} from "@higuma/editor-controls/inspector";
import {
  collectFigBoxes,
