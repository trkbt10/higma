...
import { createSingleSelection, createMultiSelection, createEmptySelection } from "@higuma/editor-core/selection";
import { addNode, removeNode, updateNode, reorderNode, findNodeById, findParentNode, insertNodeInTree, updateNodeInTree } from "@higuma/fig-builder/node-ops";
import type { FigNodeId, FigDesignNode } from "@higuma/fig/domain";
import { nextNodeId, createIdCounter } from "@higuma/fig-builder/types";
import type { HandlerMap } from "./handler-types";
import { getActivePage } from "../node-geometry";
import type { SelectionState } from "@higuma/editor-core/selection";
import type { FigEditorState } from "../types";
import { outlineNode } from "./outline-node";
import { createBooleanOperationEnum, type BooleanOperationType } from "@higuma/fig-renderer/scene-graph";
