...
import { calculateResizedDimensions } from "@higuma/editor-core/geometry";
import { normalizeAngle } from "@higuma/editor-core/geometry";
import { rotateShapeAroundCenter } from "@higuma/editor-core/geometry";
import { pushHistory } from "@higuma/editor-core/history";
import { updateNode } from "@higuma/fig-builder/node-ops";
import type { FigDesignDocument, FigNodeId, FigPageId } from "@higuma/fig/domain";
