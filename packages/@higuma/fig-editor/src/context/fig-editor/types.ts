...
import type { FigDesignDocument, FigDesignNode, FigPage, FigNodeId, FigPageId } from "@higuma/fig/domain";
import type { FigImage } from "@higuma/fig/parser";
import type { NodeSpec } from "@higuma/fig-builder/types";
import type { BooleanOperationType } from "@higuma/fig-renderer/scene-graph";
import type { UndoRedoHistory } from "@higuma/editor-core/history";
import type { SelectionState } from "@higuma/editor-core/selection";
import type { DragState, ResizeHandlePosition } from "@higuma/editor-core/drag-state";
