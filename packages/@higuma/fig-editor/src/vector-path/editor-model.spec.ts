...
import { createFigDesignDocument } from "@higuma/fig-builder";
import type { FigDesignBlob, FigDesignDocument, FigDesignNode, FigNodeId } from "@higuma/fig/domain";
import {
  addVectorPathPoint,
...
const EDGE_CASES_FIG = path.resolve(
  __dirname,
  "../../../../@higuma/fig-renderer/fixtures/edge-cases/edge-cases.fig",
);
