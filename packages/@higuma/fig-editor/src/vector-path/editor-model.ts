...
import type { FigDesignBlob, FigDesignNode, FigNodeId } from "@higuma/fig/domain";
import type { FigMatrix, FigVectorPath } from "@higuma/fig/types";
...
import {
  ...
  generateRectContour,
  generateStarContour,
} from "@higuma/fig-renderer/scene-graph";
