...
import { dfsById, walkTree } from "@higuma/fig/tree";
 ...
 * `@higuma/fig/tree`. Inline DFS-by-id is banned by the ESLint rule
 ...
 *
 * Uses the `walkTree` SoT primitive (`@higuma/fig/tree`) — the
