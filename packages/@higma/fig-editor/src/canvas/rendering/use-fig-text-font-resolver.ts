...
import type { FigDesignNode, FigPage } from "@higma/fig/domain";
import { createCachedTextFontResolver, type TextFontResolver } from "@higma/fig-renderer/text";
import type { CachingFontLoader, FontLoadOptions } from "@higma/fig-renderer/font";
import { detectWeight, isItalic, isOblique } from "@higma/fig-renderer/font";
