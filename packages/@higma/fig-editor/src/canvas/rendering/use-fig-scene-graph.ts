...
import type { FigPage, FigDesignNode, FigStyleRegistry } from "@higma/fig/domain";
import type { FigImage } from "@higma/fig/parser";
import { buildSceneGraph, type BuildSceneGraphOptions } from "@higma/fig-renderer/scene-graph";
