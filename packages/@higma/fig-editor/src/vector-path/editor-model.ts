...
import type { FigDesignBlob, FigDesignNode, FigNodeId } from "@higma/fig/domain";
import type { FigMatrix, FigVectorPath } from "@higma/fig/types";
...
import {
  ...
  generateRectContour,
  generateStarContour,
} from "@higma/fig-renderer/scene-graph";
