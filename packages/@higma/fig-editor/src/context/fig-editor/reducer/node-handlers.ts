...
import { createSingleSelection, createMultiSelection, createEmptySelection } from "@higma/editor-core/selection";
import { addNode, removeNode, updateNode, reorderNode, findNodeById, findParentNode, insertNodeInTree, updateNodeInTree } from "@higma/fig-builder/node-ops";
import type { FigNodeId, FigDesignNode } from "@higma/fig/domain";
import { nextNodeId, createIdCounter } from "@higma/fig-builder/types";
import type { HandlerMap } from "./handler-types";
import { getActivePage } from "../node-geometry";
import type { SelectionState } from "@higma/editor-core/selection";
import type { FigEditorState } from "../types";
import { outlineNode } from "./outline-node";
import { createBooleanOperationEnum, type BooleanOperationType } from "@higma/fig-renderer/scene-graph";
