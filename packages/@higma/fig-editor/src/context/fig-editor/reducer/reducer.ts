...
import type { FigDesignDocument, FigNodeId } from "@higma/fig/domain";
...
import { createHistory } from "@higma/editor-core/history";
import { createEmptySelection } from "@higma/editor-core/selection";
