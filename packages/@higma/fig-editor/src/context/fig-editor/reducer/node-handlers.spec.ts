...
import type { FigDesignDocument, FigDesignNode, FigNodeId, FigPageId } from "@higma/fig/domain";
import { DEFAULT_PAGE_BACKGROUND, EMPTY_FIG_STYLE_REGISTRY } from "@higma/fig/domain";
import { buildSceneGraph, createNodeId, evaluateBooleanPathResult, type SceneNode } from "@higma/fig-renderer/scene-graph";
