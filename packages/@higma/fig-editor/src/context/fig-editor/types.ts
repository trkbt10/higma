...
import type { FigDesignDocument, FigDesignNode, FigPage, FigNodeId, FigPageId } from "@higma/fig/domain";
import type { FigImage } from "@higma/fig/parser";
import type { NodeSpec } from "@higma/fig-builder/types";
import type { BooleanOperationType } from "@higma/fig-renderer/scene-graph";
import type { UndoRedoHistory } from "@higma/editor-core/history";
import type { SelectionState } from "@higma/editor-core/selection";
import type { DragState, ResizeHandlePosition } from "@higma/editor-core/drag-state";
