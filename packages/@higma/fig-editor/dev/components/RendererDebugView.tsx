...
import type { ParsedFigFile } from "@higma/fig/parser";
import { parseFigFile, buildNodeTree, findNodesByType } from "@higma/fig/parser";
import { loadFigFile } from "@higma/fig/roundtrip";
import { treeToDocument } from "@higma/fig-builder/context";
import type { FigDesignDocument, FigDesignNode } from "@higma/fig/domain";
import type { FigNode } from "@higma/fig/types";
import { preResolveSymbols } from "@higma/fig/symbols";
import { renderCanvas } from "@higma/fig-renderer/svg";
import { createBrowserFontLoader, isBrowserFontLoaderSupported } from "@higma/fig-renderer/font-drivers/browser";
import { createCachingFontLoader } from "@higma/fig-renderer/font";
import { buildSceneGraph } from "@higma/fig-renderer/scene-graph";
import type { SceneGraph } from "@higma/fig-renderer/scene-graph";
import { Button, Select, Tabs, Toggle, colorTokens, spacingTokens, fontTokens, radiusTokens } from "@higma/ui-components";
import {
  InspectorCanvasOverlay,
  InspectorTreePanel,
  CategoryLegend,
} from "@higma/editor-controls/inspector";
import {
  collectFigBoxes,
