 ...
 *
 * Usage:
 *   bun packages/@higma/fig-renderer/scripts/generate-text-webgl-fixtures.ts
 */
...
import { createFigFile, frameNode, textNode, roundedRectNode, ellipseNode } from "@higma/fig-builder/fig-file";
import {
  generateTextGlyphs,
