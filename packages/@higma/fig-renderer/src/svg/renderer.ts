...
import type { FigBlob, FigImage } from "@higma/fig/parser";
...
import { buildFigStyleRegistry } from "@higma/fig/symbols";
import { convertFigNode } from "@higma/fig-builder/context";
