...
import { toNodeId, EMPTY_FIG_STYLE_REGISTRY } from "@higma/fig/domain";
import type { FigPaint, FigEffect } from "@higma/fig/types";
...
describe("INSTANCE resolution — property merge", () => {
  ...
  it("SYMBOL fills always win over directly-set INSTANCE fills", () => {
    // Per mergeSymbolProperties (SoT in @higma/fig/symbols):
