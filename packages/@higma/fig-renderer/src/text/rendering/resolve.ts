...
import type { FigBlob } from "@higma/fig/parser";
import type { DerivedTextData } from "@higma/fig/domain";
import type { KiwiEnumValue, FigDerivedTextData, FigFontMetaData } from "@higma/fig/types";
