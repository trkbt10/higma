 ...
 *
 * SoT for font/value types: @higma/fig/types (FigFontName, FigValueWithUnits).
 * This file re-exports them for convenience and defines text-layout-specific types.
 */

import type { FigMatrix, FigPaint, FigFontName, FigValueWithUnits } from "@higma/fig/types";
