 ...
 * (`@higma/fig/symbols/resolve-context`) which interns the result
 ...
 *
 * Routes through the `walkTree` SoT primitive (`@higma/fig/tree`)
 ...
 * `@higma/fig/symbols/resolve-context`) which interns the result per
