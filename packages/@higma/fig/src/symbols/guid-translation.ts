...
import type { FigNode, FigComponentPropAssignment } from "@higma/fig/types";
import { getNodeType, parseGuidString, decodePathCommands, type FigGuid, type FigBlob, type PathCommand } from "@higma/fig/parser";
import type { FigKiwiSymbolOverride } from "@higma/fig/types";
