...
```tsx
import { TextFormattingEditor, ParagraphFormattingEditor } from "@higma/editor-controls";
...
```tsx
import { FontFamilySelect, useDocumentFontFamilies } from "@higma/editor-controls";
...
```tsx
import { ZoomControls, ZOOM_STEPS, getNextZoomValue } from "@higma/editor-controls";
...
```tsx
import { EditorShell, CanvasArea } from "@higma/editor-controls";
